...
public class UserAccount {
    ...
    @Column(name = "password_updated_at", columnDefinition = "DATETIME(6)")
    ...
    @Column(name = "deactivated_at", columnDefinition = "DATETIME(6)")
    ...
    public UserAccount(String email, String passwordHash, String displayName) {
        ...
        this.passwordHash = requireText(passwordHash, 255, "passwordHash");
        this.displayName = requireText(displayName, 100, "displayName").trim();
    ...
    private static String normalizeEmail(String value) {
        return requireText(value, 320, "email")
                .trim()
