...
public class SecurityConfiguration {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, ApiProblems problems) throws Exception {
        return http.cors(Customizer.withDefaults())
                ...
                .build();
        // CSRF remains enabled. No login form, Basic authentication, generated user or token workflow.
    }
    ...
    CorsConfigurationSource corsConfigurationSource(
        ...
        configuration.setAllowedHeaders(List.of("Content-Type", "Authorization", "X-CSRF-TOKEN", "X-Request-ID"));
